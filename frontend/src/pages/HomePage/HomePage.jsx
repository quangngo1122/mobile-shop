    ...
    <Loading isPending={isPending || loading}>
      ...
      <WrapperBanner>
        ...
        >
          ...
          <p style={{ color: "gray" }}>
            Tại Phone Plaza, chúng tôi mang đến cho bạn những sản phẩm điện
            thoại tốt nhất với mức giá cạnh tranh. Khám phá ngay bộ sưu tập đa
            dạng và tìm kiếm chiếc điện thoại hoàn hảo cho bạn!
          </p>
        </WrapperBannerText>
        <WrapperBannerImg
          ref={imgRef}
      ...
      <div
        className="body"
        style={{ width: "100%", background: "#efefef", paddingTop: "20px" }}
      >
        <div
          id="container"
          ...
          <Row style={{ padding: "0 30px" }}>
            ...
            <WrapperNews span={8}>
              ...
              <NewsItem>
                ...
                />
                <NewsContent>
                  <NewsTitle onClick={handleNavigateNews}>
